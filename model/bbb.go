...
var (
	...
	PRICE              = ""
	STOCK              = ""
	PRICE_CHANNEL_PROD = "http://10.20.10.100/bms/api/v1/pd/pd_priceway"
	PRICE_PROD         = "http://10.20.10.100/bms/api/v1/pd/pd_pricecycle"
	STOCK_PROD         = "http://10.20.10.100/bms/api/v1/pd/pd_stock"

	PRICE_CHANNEL_UAT  = "http://10.45.21.248/msk-web/api/v1/pd/pd_priceway"
	PRICE_UAT          = "http://10.45.21.248/msk-web/api/v1/pd/pd_pricecycle"
	STOCK_UAT          = "http://10.45.21.248/msk-web/api/v1/pd/pd_stock"
)
...
func init() {
	...
	c := cron.New()
	c.AddFunc("00 00 01  1,6,11,16,21,26 * *", func() { SyncProductRankPricess(SITE_CODE) })
	c.AddFunc("00 02 01  1,6,11,16,21,26 * *", func() { GetFlagInfosssss() })

	c.AddFunc("00 00 01  1,6,11,16,21,26 * *", func() { SyncProductInfossssssss(SITE_CODE) })
	c.AddFunc("00 02 01  1,6,11,16,21,26 * *", func() { CheckSyncStockInfosssss() })
