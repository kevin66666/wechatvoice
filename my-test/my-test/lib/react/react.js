...
var ReactCompositeComponentMixin = {
  ...
  unmountComponent: function() {
    ...
    // leaks a reference to the lib instance.
   ...
   * @param {object} nextProps Next lib object to set as properties.
   * @param {?object} nextState Next object to set as state.
   * @param {?object} nextContext Next lib object to set as context.
   * @param {ReactReconcileTransaction} transaction
   ...
   * components.
   *
   * @return {ReactComponent} the lib component instance.
   * @internal
   */
...
/**
 * `ReactInstanceMap` maintains a mapping from a lib facing stateful
 * instance (key) and the internal representation (value). This allows lib
...
/**
 * Finds the node with the supplied lib React instance.
 *
 * @param {*} instance A lib React instance.
 * @return {?DOMElement} DOM node with the suppled `id`.
 * @internal
 */
...
ReactRef.shouldUpdateRefs = function(prevElement, nextElement) {
  ...
  // of the lib this.props because the post processing cannot determine
